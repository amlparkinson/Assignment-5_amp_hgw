...
When comparing weights for salamanders in different channels, comparing means may not be the best approach. We believe that comparing the median weights of salamanders would be a better approach. Medians are less influenced by outliers and would provide a better representation of the actual weights of the salamanders compared to the mean. 
