...
# ASK ALLISON - Is it ok to have negative error bar??
```
...
- There is no significant difference in 2017 salamander weights in clear cut forests compared to old growth forests. (reference figure or table here). 
